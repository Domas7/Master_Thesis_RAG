...
retriever = db.as_retriever(
    search_kwargs={
        ...
        "score_threshold": 0.7  # Only return relatively confident matches
    }
)
print("5")
...
You are an expert in analyzing NASA documents for different recorded missions. Based on the following context, please provide concise answers gotten from the context.
...
if __name__ == "__main__":
    ...
    question = "What can we learn from the 2000 HESSI mission?"
    print("\nQuestion:", question)
